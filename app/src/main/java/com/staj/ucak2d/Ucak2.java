...
public class Ucak2 extends Ucak {
    public int speed = 10;
    ...
    Ucak2(Resources res) {
        ...
        ucak1 = BitmapFactory.decodeResource(res, R.drawable.ucak11);
        ucak2 = BitmapFactory.decodeResource(res, R.drawable.ucak22);
        ucak3 = BitmapFactory.decodeResource(res, R.drawable.ucak33);
        ucak4 = BitmapFactory.decodeResource(res, R.drawable.ucak44);
